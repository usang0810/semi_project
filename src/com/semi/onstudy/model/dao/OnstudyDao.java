...
public class OnstudyDao {
	...
	public List<Onstudy> selectMainList(Connection conn) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				onstudy = new Onstudy(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getInt("MEMBER_COUNT"), rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"),
						rset.getDate("ONSTUDY_DEADLINE_DT"), rset.getInt("ONSTUDY_CERTIFY_COUNT"),
						rset.getInt("ONSTUDY_FEE"), rset.getInt("ONSTUDY_WEEKS"), rset.getString("CATEGORY_NM"),
						rset.getInt("ONSTUDY_Dday"), rset.getString("IMAGE_PATH"));
	...
	public List<Onstudy> selectOnstudyPList(Connection conn) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				onstudy = new Onstudy(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getDate("ONSTUDY_DEADLINE_DT"),
						rset.getInt("MEMBER_COUNT"), rset.getInt("ONSTUDY_DDAY"), rset.getInt("SUM_FEE"),
	...
	public List<Onstudy> selectOnstudyMList(Connection conn) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				onstudy = new Onstudy(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_FEE"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getDate("ONSTUDY_DEADLINE_DT"), rset.getString("CATEGORY_NM"), rset.getInt("MEMBER_COUNT"),
						rset.getString("IMAGE_PATH"));
				mList.add(onstudy);
			}
		} finally {
		...
		try {
			...
			while (rset.next()) {
				onstudy = new Onstudy(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_FEE"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getDate("ONSTUDY_DEADLINE_DT"), rset.getString("CATEGORY_NM"),
						rset.getString("IMAGE_PATH"));
				dList.add(onstudy);
			}
		} finally {
	...
	public List<Onstudy> selectList(Connection conn, String condition, int currentPage, int limit) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				onstudy = new Onstudy(rset.getInt("RNUM"), rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_FEE"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getDate("ONSTUDY_DEADLINE_DT"), rset.getString("CATEGORY_NM"),
						rset.getString("IMAGE_PATH"));
	...
	public Onstudy selectOnstudy(Connection conn, int onstudyNo) throws Exception {
		...
		try {
			...
			rset = pstmt.executeQuery();
			if (rset.next()) {
				onstudy = new Onstudy(onstudyNo, rset.getString("ONSTUDY_TITLE"), rset.getDate("ONSTUDY_START_DT"),
						rset.getDate("ONSTUDY_END_DT"), rset.getInt("ONSTUDY_CERTIFY_COUNT"),
						rset.getInt("ONSTUDY_FEE"), rset.getString("ONSTUDY_ADD_COMMENT"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getString("CATEGORY_NM"), rset.getInt("MEMBER_COUNT"), rset.getInt("ONSTUDY_Dday"),
	...
	public List<Onstudy> sameCategory(Connection conn, int onstudyNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				sameCategory = new Onstudy(rset.getString("ONSTUDY_TITLE"), rset.getDate("ONSTUDY_START_DT"),
						rset.getDate("ONSTUDY_END_DT"), rset.getInt("ONSTUDY_CERTIFY_COUNT"),
	...
	public List<Onstudy> selectOnstudyList(Connection conn, int memberNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				...
				onstudy = new Onstudy(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_FEE"), rset.getString("CATEGORY_NM"),
						rset.getString("IMAGE_PATH"));
	...
	public Onstudy selectUpdate(Connection conn, int onstudyNo) throws Exception {
		...
		try {
			...
			if (rset.next()) {
				...
				onstudy = new Onstudy(rset.getString("ONSTUDY_TITLE"), rset.getString("IMAGE_PATH"),
						rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getString("ONSTUDY_ADD_COMMENT"));
			}
		} finally {
			close(rset);
			close(pstmt);
		...
		try {
			...
			while (rset.next()) {
				...
				onstudy = new Onstudy(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getDate("ONSTUDY_START_DT"), rset.getDate("ONSTUDY_END_DT"), rset.getInt("ONSTUDY_WEEKS"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_FEE"), rset.getString("CATEGORY_NM"),
						rset.getString("IMAGE_PATH"), rset.getInt("MEMBER_COUNT"), rset.getInt("TODAY_CERTIFY_CHECK"));
				nList.add(onstudy);
			}
	...
	public List<CertifyCount> todayWeek(Connection conn, int memberNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				certifyCount = new CertifyCount(rset.getInt("ONSTUDY_NO"), memberNo, rset.getInt("TODAY_CERTIFY_COUNT"),
						rset.getInt("N_WEEK"), rset.getInt("WEEK_CERTIFY_COUNT"), rset.getInt("ONSTUDY_CERTIFY_COUNT"),
	...
	public List<CertifyCount> checkRate(Connection conn, int memberNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				certifyCount = new CertifyCount(rset.getInt("ONSTUDY_NO"), rset.getInt("SUM(WEEK_CERTIFY_COUNT)"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_WEEKS"));
	...
	public List<CBoard> selectList(Connection conn, int currentPage, int limit, int onstudyNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				...
				cBoard = new CBoard(rset.getInt("RNUM"), rset.getInt("ONSTUDY_BOARD_NO"),
						rset.getString("ONSTUDY_BOARD_TITLE"), rset.getDate("ONSTUDY_BOARD_CREATE_DT"),
						rset.getDate("ONSTUDY_BOARD_MODIFY_DT"), rset.getInt("ONSTUDY_BOARD_COUNT"),
						rset.getInt("ONSTUDY_NO"), rset.getString("MEMBER_ID"));
				bList.add(cBoard);
			}
	...
	public CBoard selectBoard(Connection conn, int boardNo) throws Exception {
		...
		try {
			...
			if (rset.next()) {
				board = new CBoard(rset.getInt("RNUM"), boardNo, rset.getString("ONSTUDY_BOARD_TITLE"),
						rset.getString("ONSTUDY_BOARD_CONTENT"), rset.getDate("ONSTUDY_BOARD_CREATE_DT"),
						rset.getDate("ONSTUDY_BOARD_MODIFY_DT"), rset.getInt("ONSTUDY_BOARD_COUNT"),
						rset.getInt("ONSTUDY_NO"), rset.getString("MEMBER_ID"));
			}
	...
	public List<CAttachment> selectFiles(Connection conn, int boardNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				...
				file = new CAttachment(rset.getInt("IMAGE_NO"), rset.getString("IMAGE_PATH"), boardNo);
				files.add(file);
			}
		} finally {
			close(rset);
	 ...
	 * @throws Exception
	 */
	public List<CBoard> searchList(Connection conn, int currentPage, int limit, int onstudyNo, String condition)
			throws Exception {
		...
		try {
			...
			while (rset.next()) {
				cBoard = new CBoard(rset.getInt("RNUM"), rset.getInt("ONSTUDY_BOARD_NO"),
						rset.getString("ONSTUDY_BOARD_TITLE"), rset.getString("ONSTUDY_BOARD_CONTENT"),
						rset.getDate("ONSTUDY_BOARD_CREATE_DT"), rset.getDate("ONSTUDY_BOARD_MODIFY_DT"),
						rset.getInt("ONSTUDY_BOARD_COUNT"), rset.getInt("ONSTUDY_NO"), rset.getString("MEMBER_ID"));
				bList.add(cBoard);
			}
	...
	public CertifyCount checkCertifyCount(Connection conn, int onstudyNo, int memberNo, int nWeek) throws Exception {
		...
		try {
			...
			if (rset.next()) {
				checkCertify = new CertifyCount(onstudyNo, memberNo, rset.getInt("TODAY_CERTIFY_COUNT"), nWeek,
						rset.getInt("WEEK_CERTIFY_COUNT"), rset.getInt("ONSTUDY_CERTIFY_COUNT"),
						rset.getInt("ONSTUDY_WEEKS"));
...
//////////////////////////////////마이페이지/////////////////////////////////////////////	
	...
	public List<MyOnstudy> myOnstudyList(Connection conn, int memberNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				...
				myOnstudy = new MyOnstudy(rset.getInt("MEMBER_NO"), rset.getInt("ONSTUDY_NO"), rset.getDouble("REFUND"),
						rset.getString("ONSTUDY_TITLE"), rset.getDate("ONSTUDY_START_DT"),
						rset.getDate("ONSTUDY_END_DT"), rset.getInt("CLOSE_CHECK"), rset.getInt("MY_CERTIFY_COUNT"),
						rset.getInt("ONSTUDY_CERTIFY_COUNT"), rset.getInt("ONSTUDY_WEEKS"), rset.getInt("ONSTUDY_FEE"),
						rset.getString("CATEGORY_NM"), rset.getString("IMAGE_PATH"));
	...
	public List<CertifyBoardTotal> CertifyTotal(Connection conn, int memberNo) throws Exception {
		...
		try {
			...
			while (rset.next()) {
				cbt = new CertifyBoardTotal(rset.getInt("ONSTUDY_NO"), rset.getString("ONSTUDY_TITLE"),
						rset.getString("CATEGORY_NM"), rset.getString("IMAGE_PATH"), rset.getDate("ONSTUDY_START_DT"),
						rset.getDate("ONSTUDY_END_DT"), rset.getInt("ONSTUDY_CERTIFY_COUNT"),
						rset.getInt("ONSTUDY_FEE"), rset.getInt("ONSTUDY_WEEKS"), rset.getInt("MEMBER_COUNT"),
						rset.getInt("TODAY_WEEK"), rset.getInt("TODAY_CERTIFY_COUNT"),
						rset.getInt("WEEK_CERTIFY_COUNT"), rset.getInt("TOTAL_COUNT"));
	 ...
	 * @throws Exception
	 */
	public int refund(Connection conn, int onstudyNo, int memberNo, int refund) throws Exception {
		PreparedStatement pstmt = null;
		int result = 0;
	...
	public int insertPoint(Connection conn, int memberNo, int refund) throws Exception {
		PreparedStatement pstmt = null;
		int result = 0;

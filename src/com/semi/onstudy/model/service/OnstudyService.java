...
/** 메인 리스트
    ...
    */
	...
	/** 온스터디 검색용 Service
	    ...
	    * @throws Exception
	    */
	public int getListCount(String searchKeyword, String searchCategory, String searchStart, String searchEnd) throws Exception {
	...
	public List<Onstudy> selectList(String searchKeyword, String searchCategory, String searchStart, String searchEnd, int currentPage, int limit) throws Exception {
...
//	}
	 ...
	 * @throws Exception
	 */
	public int updateBoard(CBoard board, int boardWriter, ArrayList<CAttachment> fList, String[] beforeImg, String savePath) throws Exception{
	...
	public int searchListCount(int onstudyNo, String searchKey, String searchValue) throws Exception{
		...
		switch(searchKey) {
		case "title" : condition = " ONSTUDY_BOARD_TITLE LIKE " + searchValue; break;
		case "writer" : condition = " MEMBER_ID LIKE " + searchValue; break;
		case "content" : condition = " ONSTUDY_BOARD_CONTENT LIKE " + searchValue; break;
		}
	 ...
	 * @throws Exception
	 */
	public List<CBoard> searchList(int currentPage, int limit, int onstudyNo, String searchKey, String searchValue) throws Exception{

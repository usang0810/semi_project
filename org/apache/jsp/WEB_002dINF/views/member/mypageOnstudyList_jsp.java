 ...
 * Generated at: 2020-02-03 12:03:45 UTC
...
progress = (int)Math.floor(((double)onstudy.getMyCertifyCount()/(double)(onstudy.getOnstudyCertifyCount() * onstudy.getOnstudyWeeks()))*100); 
      ...
      out.print(onstudy.getOnstudyNo() );
      out.write("\" id=\"certify\" style=\"width:30%; float: left;\">인증하기</a>&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t");
if ( onstudy.getRefundD() == -1 && onstudy.getCloseCheck() == 1) {
      out.write(" <!-- 미환급 + 온스터디 종료 -->\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" value=\"");
      out.print(onstudy.getOnstudyNo() );
      out.write("\" class=\"onstudyNo\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" value=\"");
      out.print(progress );
      ...
      out.print(onstudy.getOnstudyFee() );
      out.write("\" class=\"fee\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" class=\"btn form-control orange-hover-btn reward-btn\" style=\"width:30%; float: left; visibility:visibility\">환급신청</a>&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t");
} else  if ( onstudy.getRefundD() >= 0 && onstudy.getCloseCheck() == 1){
      out.write("<!-- 환급  + 온스터디 종료 -->\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn form-control orange-btn\" style=\"width:30%; float: left; disabled\">환급완료</a>&nbsp;&nbsp;\t\r\n");
      out.write("\t\t\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t    });\r\n");
      out.write("\t   \t\r\n");
      out.write("\t   \t$(\".reward-btn\").on(\"click\",function(){\r\n");
      out.write("\t   \t\tvar check = $(this);\r\n");
      out.write("\t   \t\tvar onstudyNo = check.parent().children(\".onstudyNo\").val();\r\n");
      out.write("\t   \t\tvar fee = check.parent().children(\".fee\").val();\r\n");
      out.write("\t   \t\tvar progress = check.parent().children(\".progress\").val();\r\n");
      out.write("\t   \t\t\r\n");
      out.write("\t   \t\tconsole.log(check);\r\n");
      out.write("\t   \t\tconsole.log(onstudyNo);\r\n");
      out.write("\t   \t\tconsole.log(fee);\r\n");
      out.write("\t   \t\tconsole.log(progress);\r\n");
      out.write("\t   \t\t\r\n");
      out.write("\t   \t\t\r\n");
      out.write("\t\t   \tif( confirm(\"환급 신청하시겠습니까?\") ) {\r\n");
      out.write(" \t\t   \t\tlocation.href =\"");
      out.print( request.getContextPath());
      out.write("/onstudy/reward?onstudyNo=\" + onstudyNo + \"&progress=\" + progress + \"&fee=\" + fee;\r\n");
      out.write(" \t   \t\r\n");
      out.write("\t\t    // 값 보내는 방법\r\n");
      out.write("\t\t   \t\r\n");
      out.write("\t\t   \t}\r\n");

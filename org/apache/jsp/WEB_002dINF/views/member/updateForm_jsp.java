 ...
 * Generated at: 2020-02-03 05:38:32 UTC
...
public final class updateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/loginedHeader.jsp", Long.valueOf(1580698249394L));
  }
 ...
 session.removeAttribute("msg"); 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tonsubmit=\"return proValidate();\">\r\n");
      ...
      out.write("    \t\r\n");
      out.write("    \t// 이미지 파일이면 false, 그 외면 true\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t// 프로필 사진 변경여부 유효성 검사\r\n");
      out.write("\t// 프로필 사진 변경 안한 뒤 submit하면 사진 에러남\r\n");
      out.write("\tfunction proValidate(){\r\n");
      out.write(" \t\tvar src = $(\"#profileImg\").prop(\"src\");\r\n");
      out.write("\t\tvar origin = \"");
      out.print(profileImagePath);
      out.write("\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar srcSplit = src.split(\"/\");\r\n");
      out.write("\t\tvar originSplit = origin.split(\"/\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tconsole.log(srcSplit[srcSplit.length-1]);\r\n");
      out.write("\t\tconsole.log(originSplit[originSplit.length-1]);\r\n");
      out.write("\t\tconsole.log(flag);\r\n");
      out.write(" \t    if(srcSplit[srcSplit.length-1] == originSplit[originSplit.length-1]){\r\n");
      out.write("\t    \talert(\"사진을 변경한 뒤 확인을 눌러주세요!\");\r\n");
      out.write("\t    \treturn false;\r\n");
      out.write("\t    }else if(flag){\r\n");
      out.write(" \t    \talert(\"프로필에 사용할 수 없는 확장자입니다.\\n다음과 같은 확장자 파일을 사용해 주세요.\\n.jpg .png .gif .jpeg .bmp .tiff .raw\");\r\n");
      out.write("\t    }else{\r\n");
      out.write("\t    \treturn true;\r\n");
      out.write("\t    }\r\n");
      out.write("\t    console.log(\"validate()\");\r\n");
      out.write("\t    return false;\r\n");
      out.write("\t    \r\n");
      out.write("\t}\r\n");
      out.write("  </script>\r\n");

 ...
 * Generated at: 2020-02-04 00:40:48 UTC
...
public final class followDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	HashMap<Integer, String> followImageMap = (HashMap<Integer, String>)request.getAttribute("followImageMap");
      ...
      out.write("/css/mypage-follow.css\">\n");
      out.write("\n");
 ...
 session.removeAttribute("msg"); 
      ...
      out.write("            <div class=\"col-md-6 p-1 following-list\">\n");
      out.write("              <p class=\"following-list-title\">Following<span class=\"mr-2 following-count\" style=\"float:right;\" id=\"following-title\">");
      out.print(follow[0] );
      out.write("</span>\n");
      out.write("              </p>\n");
      out.write("              <div class=\"col-md-12 pt-3 pb-3 mt-0 following-list-content\">\n");
      out.write("                <ul>\n");
      out.write("                \t");
for(Member following : followList[0]){ 
      out.write("\n");
      out.write("\t                  <li class=\"id-list\" name=\"id\" value=\"");
      out.print(following.getMemberNo() );
      out.write("\">\n");
      out.write("\t                  \t<div style=\"display: inline-block\" class=\"member-wrap\">\n");
      out.write("\t\t                  \t");
if(followImageMap.get(following.getMemberNo()) != null){ 
      out.write("\n");
      out.write("\t\t\t                  \t<img src=\"");
      out.print(request.getContextPath() + followImageMap.get(following.getMemberNo()) );
      out.write("\">\t                  \t\n");
      out.write("\t\t                  \t");
}else{ 
      out.write("\n");
      out.write("\t\t\t                  \t<img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/navi-icon-default.png\">\t                  \t\n");
      out.write("\t\t                  \t");
} 
      out.write("\n");
      out.write("\t                  \t\t<span>");
      out.print(following.getMemberId() );
      out.write("</span>\n");
      out.write("\t                  \t</div>\n");
      out.write("\t                    <div class=\"fa fa-window-close cancle-follow-btn\" style=\"display: inline-block\"></div>\n");
      out.write("\t                  </li>\n");
      out.write("                \t");
} 
      out.write("\n");
      ...
      out.write("              </div>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"col-md-6 p-1 follower-list\">\n");
      out.write("              <p class=\"follower-list-title\">Follower<span class=\"mr-2 follower-count\" style=\"float:right;\">");
      out.print(follow[1] );
      out.write("</span></p>\n");
      out.write("              <div class=\"col-md-12 pt-3 pb-3 mt-0 following-list-content follower-list-content\">\n");
      out.write("                <ul>\n");
      out.write("                \t");
for(Member follower : followList[1]){ 
      out.write("\n");
      out.write("                \t\t<li value=\"");
      out.print(follower.getMemberNo() );
      out.write("\">\n");
      out.write("                \t\t\t");
if(followImageMap.get(follower.getMemberNo()) != null){ 
      out.write("\n");
      out.write("\t\t                  \t\t<img src=\"");
      out.print(request.getContextPath() + followImageMap.get(follower.getMemberNo()) );
      out.write("\">\t                  \t\n");
      out.write("\t\t                  \t");
}else{ 
      out.write("\n");
      ...
      out.write("\n");
      out.write("                \t\t\t<span>");
      out.print(follower.getMemberId() );
      out.write("</span>\n");
      out.write("                \t\t</li>\n");
      out.write("                \t");
} 
      ...
      out.write("  <script>\n");
      out.write("    $(function () {\n");
      out.write("      $(\".cancle-follow-btn\").on({\n");
      out.write("        \"click\": function () {\n");
      out.write("          var result = confirm('팔로우를 취소하시겠습니까?');\n");
      out.write("       \t console.log($(this).parent().val());\n");
      out.write("          if (result) {\n");
      out.write("        \t  var memberNo = $(this).parent();\n");
      out.write("              \n");
      out.write("              $.ajax({\n");
      out.write("\t\t\t\t\turl : \"unFollow\",\n");
      out.write("\t\t\t\t\tdata : {memberNo: memberNo.val()},\n");
      out.write("\t\t\t\t\ttype : \"GET\",\n");
      out.write("\t\t\t\t\tsuccess : function(result){\n");
      out.write("\t\t\t\t\t\tif( result == \"1\"){\n");
      out.write("\t\t\t\t\t\t\t$(\"#following-title\").text($(\"#following-title\").text()-1);\n");
      out.write("\t\t\t\t\t\t\t$(\"#mypage-following\").text($(\"#mypage-following\").text()-1)\n");
      out.write("\t\t\t\t\t\t\tmemberNo.detach();\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t}else{\n");
      out.write("\t\t\t\t\t\t\talert(\"언팔로우 실패\");\t\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t},\n");
      out.write("\t\t\t\t\terror : function(e){\n");
      out.write("\t\t\t\t\t\tconsole.log(\"언팔로우 ajax 실패\");\t\n");
      ...
      out.write("      });\n");
      out.write("      \n");
      out.write("      $(\".follower-list-content li\").on(\"click\", function(){\n");
      out.write("    \t location.href=\"../member/profileDetail?memberNo=\" + $(this).val();\n");
      out.write("      });\n");
      out.write("      \n");
      out.write("      $(\".id-list .member-wrap\").on(\"click\", function(){\n");
      out.write("    \t  location.href=\"../member/profileDetail?memberNo=\" + $(this).parent().val();\n");
      out.write("      })\n");
      out.write("      \n");
      out.write("    });\n");
      out.write("  </script>\n");

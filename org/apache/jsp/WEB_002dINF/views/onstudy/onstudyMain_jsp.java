 ...
 * Generated at: 2020-02-04 00:19:56 UTC
...
public final class onstudyMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String searchEndDt = request.getParameter("searchEndDt");
      ...
      out.write("    <style>\n");
      out.write("    \t#container{\n");
      out.write("    \t\tmargin : 200px auto 100px auto;\n");
      out.write("    \t}\n");
      out.write("    </style>\n");
      out.write("\n");
      out.write("\n");
 ...
 session.removeAttribute("msg"); 
      ...
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <!-- 검색  ../onstudy/searchList-->\n");
      out.write("            <div class=\"row\">\n");
      out.write("              <div class=\"col-md-12 onstudy-main-search\">\n");
      out.write("                <form method=\"get\" action=\"../onstudy/searchList\" onsubmit=\"return validate();\">\n");
      out.write("                  <div class=\"onstudy-search-wrap\">\n");
      out.write("\t                 <input type=\"text\"  class=\"col-sm-8 form-control input-content input-comment\" id=\"search-keyword\" name=\"search-keyword\" placeholder=\"검색할 단어를 입력하세요\">\n");
      out.write("\t                 <button class=\"more-btn form-control orange-btn-style orange-hover-btn\" id=\"search-btn\" type=\"submit\">검색</button><br>\n");
      out.write("                  </div>\n");
      out.write("                  <a class=\"option-detail-btn\" href=\"#option-detail\" data-toggle=\"collapse\"><b>세부 옵션 설정 <span id=\"option-detail-icon\">▼</span></b></a><br>\n");
      out.write("                  <div id=\"option-detail\" class=\"collapse\">\n");
      out.write("                    <b>- 카테고리</b><br>\n");
      out.write("\t\t\t\t\t\t<div class=\"btn-category btn-group-toggle\" name=\"search-category\" data-toggle=\"buttons\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"영어\"> 영어 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"중국어\"> 중국어 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"일본어\"> 일본어 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"스페인어\"> 스페인어 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"프랑스어\"> 프랑스어 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"한자\"> 한자 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"JAVA\"> JAVA \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"C언어\"> C언어 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"PYTHON\"> PYTHON \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"자바스크립트\"> 자바스크립트 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"정보처리기사\"> 정보처리기사 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"수학\"> 수학 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"한국사\"> 한국사 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"과학\"> 과학 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"사회\"> 사회 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"공무원\"> 공무원 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"임용고시\"> 임용고시 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"수능\"> 수능 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"전산세무\"> 전산세무 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"btn btn-sm btn-outline-dark\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"search-category\" value=\"기타 등등\"> 기타 등등 \n");
      out.write("\t\t\t\t\t\t\t\t\t</label>&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("                    <br>\n");
      out.write("                    <b>- 기간설정</b><br><br>\n");
      out.write("                    <input class=\"form-control input-content input-comment\" type=\"date\" id=\"search-start\" name=\"search-start\">\n");
      out.write("                    ~\n");
      out.write("                    <input class=\"form-control input-content input-comment\" type=\"date\" id=\"search-end\" name=\"search-end\">\n");
      out.write("                  </div>\n");
      out.write("                </form>\n");
      out.write("              </div>\n");
      out.write("            </div>\n");
      ...
      out.write("                  <div class=\"col-md-12\">\n");
      out.write("                    <h3>\n");
      out.write("                      인기 온스터디&nbsp;<span class=\"badge badge-warning\" style=\"color: white;\">HOT</span>\n");
      out.write("                    </h3>\n");
      out.write("                    <hr>\n");
      out.write("                  </div>\n");
      out.write("                </div>\n");
...
for(Onstudy onstudy : mList) { 
      ...
      out.write("                  <div class=\"col-md-12\">\n");
      out.write("                    <h3>\n");
      out.write("                      신규 온스터디&nbsp;<span class=\"badge badge-warning\"  style=\"color: white;\">NEW</span>\n");
      out.write("                    </h3>\n");
      out.write("                    <hr>\n");
      out.write("                  </div>\n");
      out.write("                </div>\n");

 ...
 * Generated at: 2020-02-03 08:42:32 UTC
...
if(boardType.equals("F")){ 
      ...
      out.write("                <select class=\"form-control input-comment\" id=\"selectOption\" name=\"searchKey\">\r\n");
...
if(boardType.equals("D")){ 
 ...
 if(bList.isEmpty()){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"6\" style=\"cursor:default;\" class=\"no-list\">존재하는 게시글이 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t  ");
 }else{ 
      out.write("\r\n");
...
if(boardType.equals("D")){ 
 ...
 if(currentPage < maxPage){ 
      ...
      out.write("\t\t\tif($(this).hasClass(\"no-list\")){\r\n");
      ...
      out.write("\t\t\tif($(\"#selectOption option:selected\").val() == \"게시글번호\"){\r\n");

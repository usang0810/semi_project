...
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-01-01', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'M', '2019-01-25', 105, 2);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 30000, 'A', '2019-05-03', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 20000, 'A', '2019-07-07', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 50000, 'M', '2019-11-19', 105, 2);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-12-01', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-12-02', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-12-03', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-12-04', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-12-05', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 20000, 'M', '2019-12-06', 105, 2);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 10000, 'A', '2019-12-10', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 30000, 'A', '2019-12-10', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 50000, 'A', '2019-12-15', 105, 1);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 30000, 'M', '2019-12-27', 105, 2);
INSERT INTO POINT_DETAIL
VALUES(SEQ_PDNO.NEXTVAL, 20000, 'M', '2019-12-31', 105, 2);
INSERT INTO POINT_DETAIL
...
CREATE OR REPLACE VIEW V_BOARD_LIST AS
    SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_MODIFY_DT, BOARD_STATUS, MEMBER_ID, BOARD_TYPE, DECLAR_STATUS
    FROM BOARD
    JOIN MEMBER ON(BOARD_WRITER=MEMBER_NO)
    LEFT JOIN MEMBER_DECLAR USING(BOARD_NO);
...
--SELECT COUNT(*) FROM STUDYNOTE WHERE STUDYNOTE_STATUS='Y' AND STUDYNOTE_WRITER=2;

---- 진행중인 온스터디
--SELECT COUNT(*)
--FROM MEMBER_ONSTUDY_LIST
--JOIN ONSTUDY USING(ONSTUDY_NO)
--WHERE ONSTUDY_STATUS = 'Y'
...
--AND MEMBER_NO=2;
--
--SELECT SYSDATE SD FROM DUAL
--WHERE SYSDATE >= SYSDATE;
--
--SELECT * FROM ONSTUDY;

--INSERT INTO FOLLOW_DETAIL VALUES(42, 3);
--INSERT INTO FOLLOW_DETAIL VALUES(42, 4);
--INSERT INTO FOLLOW_DETAIL VALUES(42, 5);
--INSERT INTO FOLLOW_DETAIL VALUES(42, 6);
--INSERT INTO FOLLOW_DETAIL VALUES(42, 7);
--INSERT INTO FOLLOW_DETAIL VALUES(42, 8);
--INSERT INTO FOLLOW_DETAIL VALUES(42, 9);
--COMMIT;

--select * from follow_detail where following=2;
--ROLLBACK;
--DELETE FROM FOLLOW_DETAIL WHERE FOLLOWING=2 AND FOLLOWER=3;
--SELECT * FROM MEMBER;
--
--SELECT * FROM FOLLOW_DETAIL WHERE FOLLOWING=3;
--
--SELECT IMAGE_PATH, MEMBER_NO FROM MEMBER_IMAGE;
--
--SELECT FOLLOWER, MEMBER_ID FROM FOLLOW_DETAIL
--JOIN MEMBER ON(FOLLOWER = MEMBER_NO)
--WHERE FOLLOWING=3;
--
--SELECT FOLLOWING, MEMBER_ID FROM FOLLOW_DETAIL
--JOIN MEMBER ON(FOLLOWING = MEMBER_NO)
--WHERE FOLLOWER=3;

--SELECT COUNT(*) FROM FOLLOW_DETAIL WHERE FOLLOWING=3;
--
--SELECT COUNT(*) FROM FOLLOW_DETAIL
--WHERE FOLLOWING = 3;
--
--SELECT COUNT(*) FROM FOLLOW_DETAIL
--WHERE FOLLOWER = 3;
--
--SELECT * FROM MEMBER;
--SELECT * FROM FOLLOW_DETAIL;

--INSERT INTO FOLLOW_DETAIL VALUES(3, 11);
--INSERT INTO FOLLOW_DETAIL VALUES(3, 12);
--INSERT INTO FOLLOW_DETAIL VALUES(3, 41);
--INSERT INTO FOLLOW_DETAIL VALUES(11, 41);
--INSERT INTO FOLLOW_DETAIL VALUES(41, 3);
--SELECT * FROM MEMBER;
--
--SELECT BOARD_TYPE, BOARD_TITLE, BOARD_CONTENT, BOARD_MODIFY_DT, BOARD_STATUS, BOARD_COUNT, MEMBER_ID, DECLAR_STATUS
--FROM BOARD
--JOIN MEMBER ON(BOARD_WRITER=MEMBER_NO)
--LEFT JOIN MEMBER_DECLAR USING(BOARD_NO);
--
...
--    WHERE B.BOARD_TYPE='D'
--    AND M.MEMBER_ID='admin')
--WHERE DE_MEMBER='user01';


--SELECT * FROM V_BOARD_LIST;
--LEFT JOIN MEMBER_DECLAR USING(BOARD_NO)
--WHERE BOARD_TYPE='D' AND DECLAR_STATUS='Y';
--
--SELECT BOARD_NO, BOARD_TITLE, DECLAR_STATUS
--FROM BOARD
--JOIN MEMBER_DECLAR USING(BOARD_NO)
--WHERE BOARD_TYPE='D';
--
--
--INSERT INTO MEMBER_DECLAR VALUES(5, DEFAULT, 2);
--INSERT INTO MEMBER_DECLAR VALUES(54, DEFAULT, 3);
--INSERT INTO MEMBER_DECLAR VALUES(55, DEFAULT, 4);
--INSERT INTO MEMBER_DECLAR VALUES(56, DEFAULT, 5);
--INSERT INTO MEMBER_DECLAR VALUES(57, DEFAULT, 6);
--INSERT INTO MEMBER_DECLAR VALUES(58, DEFAULT, 7);
--INSERT INTO MEMBER_DECLAR VALUES(59, DEFAULT, 8);
--INSERT INTO MEMBER_DECLAR VALUES(60, DEFAULT, 9);
--INSERT INTO MEMBER_DECLAR VALUES(61, DEFAULT, 11);
--INSERT INTO MEMBER_DECLAR VALUES(62, DEFAULT, 12);
--INSERT INTO MEMBER_DECLAR VALUES(63, DEFAULT, 13);
--INSERT INTO MEMBER_DECLAR VALUES(64, DEFAULT, 21);
--INSERT INTO MEMBER_DECLAR VALUES(65, DEFAULT, 2);
--INSERT INTO MEMBER_DECLAR VALUES(66, DEFAULT, 2);
--INSERT INTO MEMBER_DECLAR VALUES(67, DEFAULT, 3);
--INSERT INTO MEMBER_DECLAR VALUES(68, DEFAULT, 4);
--INSERT INTO MEMBER_DECLAR VALUES(69, DEFAULT, 5);
--INSERT INTO MEMBER_DECLAR VALUES(70, DEFAULT, 6);
--INSERT INTO MEMBER_DECLAR VALUES(71, DEFAULT, 7);
--
--SELECT * FROM BOARD WHERE BOARD_TYPE='D';
--SELECT * FROM MEMBER;
--SELECT * FROM MEMBER_DECLAR;
--DELETE FROM MEMBER_DECLAR;
--COMMIT;

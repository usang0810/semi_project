...
CREATE OR REPLACE VIEW V_ONSTUDY_LIST AS
    SELECT ONSTUDY_NO, ONSTUDY_TITLE, ONSTUDY_START_DT, ONSTUDY_END_DT, ONSTUDY_FEE, 
        (SELECT COUNT(*) FROM MEMBER_ONSTUDY_LIST WHERE ONSTUDY_NO=O.ONSTUDY_NO) ALL_COUNT, CATEGORY_NM
    FROM ONSTUDY O

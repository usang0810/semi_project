...
CREATE TABLE ONSTUDY(
	...
	ONSTUDY_WRTIER NUMBER REFERENCES MEMBER,
	CATEGORY_CD NUMBER REFERENCES STUDY_CATEGORY
);
...
COMMENT ON COLUMN ONSTUDY.ONSTUDY_MAX_AMOUNT IS '최대 참가비(최소 10000)';
...
INSERT INTO ONSTUDY(ONSTUDY_NO, ONSTUDY_TITLE, ONSTUDY_START_DT, ONSTUDY_END_DT, ONSTUDY_CERTIFY_COUNT,
                                ONSTUDY_MAX_AMOUNT, ONSTUDY_ADD_COMMENT, ONSTUDY_WRTIER, CATEGORY_CD)
VALUES(SEQ_ONO.NEXTVAL, '관리자 테스트', '2020-01-23', '2020-02-13', 3, 50000, '테스트 온스터디입니다', 1, 1);
...
CREATE TABLE ONSTUDY_BOARD(
	...
	ONSTUDY_NO NUMBER REFERENCES ONSTUDY,
	ONSTUDY_COMMENT_WRITER NUMBER REFERENCES MEMBER
);
...
COMMENT ON COLUMN ONSTUDY_BOARD.ONSTUDY_COMMENT_WRITER IS '작성자';
...
SELECT *
FROM (SELECT ROWNUM RNUM, MEMBER_NO, MEMBER_ID, MEMBER_NM, MEMBER_PHONE, MEMBER_POINT, MEMBER_DECLAR_COUNT, MEMBER_STATUS
            FROM V_MEMBER_LIST
            WHERE MEMBER_POINT=0)

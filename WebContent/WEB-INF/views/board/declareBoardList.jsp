...
<%-- <% if(((loginMember != null) && (board.getSecretStatus()=='Y')) && (board.getBoardWriter().equals(loginMember.getMemberId()) || loginMember.getMemberId().equals("admin"))) { %> --%>
	                              			<td class="has-list"><%= board.getBoardTitle()%></td>
<%-- 	                              			<% }else {%> --%>
<!-- 	                              			<td class="has-list">비밀글입니다</td> -->
<%-- 	                              			<% } %> --%>

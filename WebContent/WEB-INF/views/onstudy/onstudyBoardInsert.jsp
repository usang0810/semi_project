            ...
            <div class="row">
              <div id="board-write-wrap" class="col-md-12">
                ...
                <div class="board-write">
                  <form class="write-form" action="<%= request.getContextPath() %>/onstudy/boardInsert?oNo=<%=oNo%>" 
                  method="post" enctype="multipart/form-data" role="form" onsubmit="return validate();">
                    <table>
                      <tr>
                        <th><label for="title">제목</label></th>
                        <td><input id="title" class="form-control input-title" type="text" name="title" placeholder="제목을 입력해주세요."></td>
                      </tr>
                      <tr>
                    ...
                    <a class="cancel-btn form-control" href="boardList?oNo=<%=oNo%>">취소</a>
                  </form>
                </div>
              </div>
            </div>
